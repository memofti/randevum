    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="w-56 flex-shrink-0 bg-slate-800 flex flex-col h-screen">
        ...
        <div className="p-3 border-t border-white/[0.07]">
          ...
          <button onClick={()=>{localStorage.removeItem('randevu_user');router.push('/login')}} className="w-full mt-2 text-xs text-white/30 hover:text-white/60 text-center py-1">Çıkış Yap</button>
        </div>
      </div>
